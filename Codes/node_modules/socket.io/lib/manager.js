 ...
 */
Manager.prototype.checkRoomid=function(roomid){
    roomid='/'+roomid;
    ...
    else{console.log('checkRoomid: false');
        console.log(this.rooms);
        return false;}
}
Manager.prototype.checkRoomidAndClient=function(roomid,email){
    roomid='/'+roomid;

    //console.log(this.roomClients);
    if(this.roomClients[email]){
        //console.log(this.roomClients[email]);
        if(this.roomClients[email][roomid])
            return true;
    }
    else
        return false;
}
Manager.prototype.roomidByClient=function(clientid){

    if(this.roomClients[clientid]){
        return roomClients[clientid];
    }
}
 /**
