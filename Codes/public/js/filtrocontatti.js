...
// controllo se � stato inserita username
...
function inputSelection(rad, tipologia, usrMail){
	var sel = rad.value; 
   ...
   if( usrMail ) {
   	  document.getElementById('mailOrUsername').innerHTML = usrMail;
   } else {
   	  document.getElementById('mailOrUsername').innerHTML = "Mail:";
   }
